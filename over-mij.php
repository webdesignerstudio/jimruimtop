    ...
    <header class="w-full bg-brandNavy sticky top-0 z-50 shadow-sm">
        <nav class="flex justify-between items-center max-w-7xl mx-auto px-6 py-4">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="over-mij.php" class="font-headline font-bold text-white border-b-2 border-brandCyan pb-1">Over Ons</a>
            ...
            <div class="hidden md:flex items-center gap-4">
                ...
                <a href="contact.php#formulier" class="bg-brandCyan text-brandNavy px-6 py-3 rounded-full font-bold hover:opacity-90 transition-all text-sm">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-16 fade-in-up">
                    ...
                    <div class="bg-white rounded-xl p-5 text-center cloud-shadow">
                        ...
                        <p class="text-brandNavy font-bold text-sm">Tilburg</p>
                    </div>
                    <div class="bg-white rounded-xl p-5 text-center cloud-shadow">
