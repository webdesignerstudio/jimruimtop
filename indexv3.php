...
<body class="bg-white font-body" style="background-color:#f0f7ff">
    ...
    <main>
        ...
        <!-- ═══════════════════════════════════════════════════════════════
             VARIANT A — Kleine tekststrook (subtielst)
             ═══════════════════════════════════════════════════════════════ -->
        <div class="text-center py-2 px-4" style="background-color:#f0f7ff">
            <p class="text-xs font-bold tracking-widest text-gray-300 uppercase mb-4">▲ VARIANT A — Kleine tekststrook</p>
            <p class="text-gray-500 text-base">
                Past uw situatie niet in een van de pakketten?
                <a href="contact.php" class="text-brandNavy font-semibold underline underline-offset-2 hover:text-brandCyan transition-colors">Jim maakt altijd een offerte op maat &rarr;</a>
            </p>
        </div>

        <!-- ═══════════════════════════════════════════════════════════════
             VARIANT B — Smalle banner/balk
             ═══════════════════════════════════════════════════════════════ -->
        <div class="text-center py-2 px-4" style="background-color:#f0f7ff">
            <p class="text-xs font-bold tracking-widest text-gray-300 uppercase mb-4">▲ VARIANT B — Smalle banner/balk</p>
        </div>
        <div class="w-full px-6 py-5" style="background-color:#e8f4f0">
            <div class="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-brandNavy font-medium text-base text-center sm:text-left">
                    <span class="material-symbols-outlined align-middle text-xl mr-1" style="vertical-align:-4px">build</span>
                    Past uw situatie niet in een van de pakketten? Jim denkt altijd mee en maakt een offerte op maat.
                </p>
                <a href="contact.php" class="flex-shrink-0 bg-brandNavy text-white text-sm font-bold px-6 py-2.5 rounded-full hover:bg-brandCyan hover:text-brandNavy transition-all whitespace-nowrap shadow-sm">
                    Vraag maatwerk aan
                </a>
            </div>
        </div>
